...
A full-featured **Task Management System** built with React.js, TypeScript, Express, and MongoDB.  
This project demonstrates authentication, protected routes, and a polished UI/UX for managing tasks efficiently.
...
- Popup feedback system (success, error, info)
...
- **UI/UX:** Styled components / CSS modules
...
```bash
git clone https://github.com/sonali0210/Task-manager.git
cd Task-manager
npm install
```
